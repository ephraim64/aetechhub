    ...
    <div className="pt-4 lg:pt-16">
        <div className='flex flex-col items-center gap-4'>
         ...
         <div className='grid grid-cols-1 my-10 items-center lg:grid-cols-2 gap-8 lg:gap-16 py-6 lg:py-16 px-4 lg:px-24 w-full bg-purple bg-opacity-20'>
             ...
             <img src={Vision} alt="" className='w-[500px] h-[330px] object-cover rounded-md'/>
         </div>
      ...
      <div className="bg-purple px-4 lg:px-24 py-16">
        ...
        <div className="flex w-full justify-center mb-4">
          <div
            className="flex flex-col items-center gap-3 bg-white rounded-2xl py-12 px-[80px] lg:px-16 cursor-pointer hover:shadow-lg transition-all hover:scale-105 duration-300 ease-linear"
